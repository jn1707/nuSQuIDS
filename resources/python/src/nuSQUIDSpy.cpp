...
BOOST_PYTHON_MODULE(nuSQUIDSpy)
{
  ...
  class_<nuSQUIDSAtm<>, boost::noncopyable, std::shared_ptr<nuSQUIDSAtm<>> >("nuSQUIDSAtm", no_init)
    ...
    .def("Set_Body",&nuSQUIDSAtm<>::Set_Body)
  ...
  class_<nuSQUIDSDecoh, boost::noncopyable, std::shared_ptr<nuSQUIDSDecoh> >("nuSQUIDSDecoh",no_init)
    ...
    .def("Set_DecoherenceBasis",&nuSQUIDSDecoh::Set_DecoherenceBasis)
    .def("Get_DecoherenceBasis",&nuSQUIDSDecoh::Get_DecoherenceBasis)
    ...
    .def("Set_DecoherenceGammaEnergyScale",&nuSQUIDSDecoh::Set_DecoherenceGammaEnergyScale)
    .def("Get_DecoherenceGammaEnergyScale",&nuSQUIDSDecoh::Get_DecoherenceGammaEnergyScale)
  ...
  class_<nuSQUIDSAtmDecoh, boost::noncopyable, std::shared_ptr<nuSQUIDSAtmDecoh> >("nuSQUIDSAtmDecoh", no_init)
    ...
    .def("Set_DecoherenceBasis",&nuSQUIDSAtmDecoh::Set_DecoherenceBasis)
    .def("Get_DecoherenceBasis",&nuSQUIDSAtmDecoh::Get_DecoherenceBasis)
    ...
    .def("Set_DecoherenceGammaEnergyScale",&nuSQUIDSAtmDecoh::Set_DecoherenceGammaEnergyScale)
    .def("Get_DecoherenceGammaEnergyScale",&nuSQUIDSAtmDecoh::Get_DecoherenceGammaEnergyScale)
